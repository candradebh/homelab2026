...
The website is generated using [Material for MkDocs](https://squidfunk.github.io/mkdocs-material) and can be viewed at [homelab.multiversonline.com.br](https://homelab.multiversonline.com.br).
...
It's running on my other cluster in the [multiversonline/horus](https://github.com/multiversonline/horus) project
(so if the homelab goes down everyone can still read the documentation).

<!-- TODO -->
<!-- This website is running in both my homelab cluster and on my other cluster in the [multiversonline/horus](https://github.com/multiversonline/horus) project (both in `apps/homelab-docs`), -->
...
<!-- - Find the TXT record for `homelab.multiversonline.com.br` and switch the `ownerID` between `homelab` and `horus` -->
