...
Because [this project](https://github.com/multiversonline/homelab) applies GitOps practices,
it's the source of truth for _my_ homelab, so you'll need to fork it to make it yours:

[:fontawesome-solid-code-fork: Fork multiversonline/homelab](https://github.com/multiversonline/homelab/fork){ .md-button }
